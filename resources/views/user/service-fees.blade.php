...
<div class="container" data-spy="scroll" data-target="#nav-scroll" data-offset="0">
    <h1 class="text-center --roboto-condensed --bold mb-3" >Service Fees</h1>
    <div class="row" >
        <div class="col-md-3">
            <nav id="side-scroll"></nav>
            <div id="nav-scroll" class="list-group">
                <a class="list-group-item" href="#repair-section">Repair</a>
                <a class="list-group-item " href="#upgrade-section">Upgrade</a>
                <a class="list-group-item " href="#print-section">Print</a>
            </div>
        </div>
        <div class="col-md-9">
            <div >

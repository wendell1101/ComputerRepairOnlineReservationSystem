            ...
            <div class="col-sm-12">
                <div class="card card-outline card-dark shadow-lg rounded p-3">
                    <div class="card-header">
                        <h3 class="text-bold">Create Service</h3>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="product_category_id" id="product-category" wire:model="service_category_id" class="custom-select
                                            @error('service_category_id') is-invalid @enderror
                                            ">
                                        ...
                                        <div class="form-group mt-2">
                                            <button type="submit" class="btn btn-outline-primary float-right" id="product-create-btn">Create Service</button>
                                        </div>
                                </div>
                            </div>
                        </form>

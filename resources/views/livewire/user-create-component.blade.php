            ...
            <div class="col-sm-12">
                <div class="card card-outline card-dark shadow-lg rounded p-3">
                    <div class="card-header">
                        <h3 class="text-bold">Create User</h3>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="first_name" id="first_name" wire:model="first_name" class="form-control
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="last_name" id="last_name" wire:model="last_name" class="form-control
                                           ...
                                           <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="password" wire:model="password" id="password" class="form-control
                                           ...
                                           <div class="col-md-6">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" name="password_confirmation" wire:model="password_confirmation" id="password-confirm" class="form-control
                                                            @error('password') is-invalid @enderror
                                                        ">
                                        ...
                                        <div class="form-group mt-2">
                                            <button type="submit" class="btn btn-outline-primary float-right" id="product-create-btn">Create User</button>
                                        </div>
                                </div>
                            </div>
                        </form>

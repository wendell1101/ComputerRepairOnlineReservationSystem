...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <head>
        ...
        <title>Your reservation status has been updated</div></title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
-->
    ...
    <![endif]-->
            ...
            <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">You have new message from </div>
                                ...
                                <tr>
                                    <td style="">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="font-size: 14px; text-align: left;">
                                            <tr>
                                                <td valign="top" style="">
                                                    <p class="text--black">Hello {{ $reservation->user->first_name }} {{ $reservation->user->last_name }}</em> </p>
                                                    <br>
                                                    <p><p class="text--black">Your reservation with a Transaction ID of: {{ $reservation->transaction_id}} has been updated to <b>{{ get_reservation_status($reservation->status)}}</b></p>
                                                    {{-- <p class="text--black"><em>Subject:</em> {{ $contact->subject }}</p>
                                                    <p class="text--black"><em>Email:</em> {{ $contact->email }}</p>
                                                    <p class="text--black"><em>Phone:</em> {{ $contact->phone }}</p>
                                                    <br>
                                                    <p class="text--black"><em>Message:</em> <br> {{ $contact->message }}</p> --}}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
